...
var _AmplifyMessageMap = _interopRequireDefault(require("../AmplifyMessageMap"));
...
var AuthPiece = /*#__PURE__*/function (_React$Component) {
  ...
  function AuthPiece(props) {
    ...
    _this.getUsernameFromInput = _this.getUsernameFromInput.bind(_assertThisInitialized(_this));
    _this.renderUsernameField = _this.renderUsernameField.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(AuthPiece, [{
    ...
    value: function renderUsernameField(theme) {
      ...
      var _this$props$usernameA2 = this.props.usernameAttributes,
          usernameAttributes = _this$props$usernameA2 === void 0 ? [] : _this$props$usernameA2;

      if (usernameAttributes === 'email') {
        return /*#__PURE__*/_react["default"].createElement(_AmplifyUI.FormField, _extends({
          theme: theme,
          ...
          required: true
        }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.EMAIL_INPUT), {
          value: value
        }));
      } else if (usernameAttributes === 'phone_number') {
        return /*#__PURE__*/_react["default"].createElement(_AmplifyUI.PhoneField, _extends({
          theme: theme,
          key: 'phone_number',
          onChangeText: function onChangeText(text) {
            return _this2.setState({
          ...
          required: true
        }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.PHONE_INPUT), {
          value: value
        }));
      } else {
        return /*#__PURE__*/_react["default"].createElement(_AmplifyUI.FormField, _extends({
          ...
          required: true
        }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.USERNAME_INPUT), {
          value: value
        }));
      }
    }
    ...
    value: function getUsernameLabel() {
      var _this$props$usernameA3 = this.props.usernameAttributes,
          usernameAttributes = _this$props$usernameA3 === void 0 ? 'username' : _this$props$usernameA3;
    ...
    value: function error(err) {
      ...
      var map = this.props.errorMessage || this.props.messageMap || _AmplifyMessageMap["default"];
