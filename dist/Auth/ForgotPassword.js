...
var ForgotPassword = /*#__PURE__*/function (_AuthPiece) {
  ...
  _createClass(ForgotPassword, [{
    ...
    value: function forgotBody(theme) {
      ...
      }, this.renderUsernameField(theme), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.AmplifyButton, _extends({
        text: _awsAmplify.I18n.get('Send').toUpperCase(),
        theme: theme,
        onPress: this.send,
        disabled: !this.getUsernameFromInput()
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.SEND_BUTTON))));
    }
  }, {
    key: "submitBody",
    value: function submitBody(theme) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        ...
        required: true
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.CONFIRMATION_CODE_INPUT))), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.FormField, _extends({
        theme: theme,
        onChangeText: function onChangeText(text) {
          return _this4.setState({
            password: text
    ...
    value: function showComponent(theme) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_AmplifyUI.Wrapper, null, /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        ...
        theme: theme
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.FORGOT_PASSWORD_TEXT)), _awsAmplify.I18n.get('Reset your password')), /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        style: theme.sectionBody
      }, !this.state.delivery && this.forgotBody(theme), this.state.delivery && this.submitBody(theme)), /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
