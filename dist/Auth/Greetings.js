...
var Greetings = /*#__PURE__*/function (_AuthPiece) {
  ...
  _createClass(Greetings, [{
    ...
    value: function getMessage() {
      ...
      if (user) {
        var _this$props$usernameA = this.props.usernameAttributes,
            usernameAttributes = _this$props$usernameA === void 0 ? [] : _this$props$usernameA;
        var name = '';
        ...
        if (usernameAttributes === 'email') {
          ...
          defaultMessage = "".concat(_awsAmplify.I18n.get('Hello'), " ").concat(name);
        }
      }
    ...
    value: function showComponent() {
      ...
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.GREETING_SIGNED_IN_TEXT)), this.getMessage()), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.AmplifyButton, _extends({
        theme: theme,
        text: _awsAmplify.I18n.get('Sign Out'),
        onPress: this.signOut,
        style: theme.navButton
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.SIGN_OUT_BUTTON))));
    }
  }]);
