  ...
  _createClass(VerifyContact, [{
    ...
    value: function createPicker(unverified) {
      ...
      if (email && phone_number) {
        return /*#__PURE__*/_react["default"].createElement(_reactNative.Picker, _extends({
        ...
        }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.VERIFY_CONTACT_PICKER)), /*#__PURE__*/_react["default"].createElement(_reactNative.Picker.Item, {
          label: _awsAmplify.I18n.get('Email'),
          value: "email"
        }), /*#__PURE__*/_react["default"].createElement(_reactNative.Picker.Item, {
    ...
    value: function verifyBody(theme) {
      ...
      }, this.createPicker(unverified), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.AmplifyButton, _extends({
        theme: theme,
        text: _awsAmplify.I18n.get('Verify'),
        onPress: this.verify,
        disabled: !this.state.pickAttr
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.VERIFY_BUTTON))));
    }
  }, {
    key: "submitBody",
    value: function submitBody(theme) {
      ...
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.SUBMIT_BUTTON))));
    }
  }, {
    key: "showComponent",
    value: function showComponent(theme) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_AmplifyUI.Wrapper, null, /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
        ...
        theme: theme
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.VERIFY_CONTACT_TEXT)), _awsAmplify.I18n.get('Verify Contact')), !this.state.verifyAttr && this.verifyBody(theme), this.state.verifyAttr && this.submitBody(theme), /*#__PURE__*/_react["default"].createElement(_reactNative.View, {
      ...
      }, (0, _Utils.setTestId)(_AmplifyTestIDs["default"].AUTH.SKIP_BUTTON)), _awsAmplify.I18n.get('Skip'))), /*#__PURE__*/_react["default"].createElement(_AmplifyUI.ErrorRow, {
        theme: theme
